# commands for source TOKYO by ~ @MFMVIP
...
async def cmds(TOKYO):
    await eor(TOKYO, Cmds)

########################  SOURCE TOKYO ~ BY: MUSTAFA (@MFMVIP)  ########################
...
async def _(event):
    ...
    if input_str == "م1":
        ...
        if r == 0:
            await event.edit(
                "𓆰 [𝙎𝙤𝙪𝙧𝙘𝙚 𝙏𝙤𝙠𝙔𝙤 - 𝘾𝙊𝙈𝙈𝘼𝙉𝘿𝙎 ](t.me/MFMVIP) 𓆪\n **✘ ∫ قائـمه اوامر الادمن :** \n⪼ `.حظر` \n⪼ `.الغاء حظر` \n⪼ `.تقيد` \n⪼ `.الغاء تقيد` \n⪼ `.رفع القيود` \n⪼ `.كتم` \n⪼ `.الغاء كتم` \n⪼ `.تثبيت` \n⪼ `.الغاء التثبيت` \n ٴ⊶─────≺ᴛᴏᴋʏᴏ≻─────⊷\n𓆩[𝙎𝙤𝙪𝙧𝙘𝙚 𝙏𝙤𝙠𝙔𝙤](t.me/TOKYO_TEAM)𓆪\n𓆩[𝙈𝙐𝙎𝙏𝘼𝙁𝘼](t.me/MFMVIP)𓆪"
            )
        else:
            await event.edit(
                "𓆰 [𝙎𝙤𝙪𝙧𝙘𝙚 𝙏𝙤𝙠𝙔𝙤 - 𝘾𝙊𝙈𝙈𝘼𝙉𝘿𝙎 ](t.me/MFMVIP) 𓆪\n **✘ ∫ قائـمه اوامر الادمن :** \n⪼ `.حظر` \n⪼ `.الغاء حظر` \n⪼ `.تقيد` \n⪼ `.الغاء تقيد` \n⪼ `.رفع القيود` \n⪼ `.كتم` \n⪼ `.الغاء كتم` \n⪼ `.تثبيت` \n⪼ `.الغاء التثبيت` \n ٴ⊶─────≺ᴛᴏᴋʏᴏ≻─────⊷\n𓆩[𝙎𝙤𝙪𝙧𝙘𝙚 𝙏𝙤𝙠𝙔𝙤](t.me/TOKYO_TEAM)𓆪\n𓆩[𝙈𝙐𝙎𝙏𝘼𝙁𝘼](t.me/MFMVIP)𓆪"
...
async def _(TOKYO):
    await eor(TOKYO, "𓆰 [𝙎𝙤𝙪𝙧𝙘𝙚 𝙏𝙤𝙠𝙔𝙤 - 𝑩𝑳𝑨𝑪𝑲𝑳𝑰𝑺𝑻](t.me/MFMVIP) 𓆪\n **✘ ∫ القائمة السوداء :** \n⪼ `.منع كلمه + الكلمه ` لمنع كلمه  \n⪼ `.الغاء منع + الكلمه` \n⪼ `.الكلمات المحظوره` \n⪼ `.ازعاج` \n⪼ `.الغاء ازعاج` \n⪼ `.قائمة الازعاج` \n ٴ⊶─────≺ᴛᴏᴋʏᴏ≻─────⊷\n𓆩[𝙎𝙤𝙪𝙧𝙘𝙚 𝙏𝙤𝙠𝙔𝙤](t.me/TOKYO_TEAM)𓆪\n𓆩[𝙈𝙐𝙎𝙏𝘼𝙁𝘼](t.me/MFMVIP)𓆪")
...
async def _(TOKYO):
    await eor(TOKYO, "𓆰 [𝙎𝙤𝙪𝙧𝙘𝙚 𝙏𝙤𝙠𝙔𝙤 - 𝑫𝑬𝑽𝑬𝑳𝑶𝑷𝑬𝑹](t.me/MFMVIP) 🧸♥️𓆪\n**ٴ⊶─────≺ᴛᴏᴋʏᴏ≻─────⊷**\n **𓄂༒** 𝙈𝙐𝙎𝙏𝘼𝙁𝘼  ↬ @MFMVIP ༗\n")
