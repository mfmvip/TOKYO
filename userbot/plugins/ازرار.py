...
CMD_HELP.update(
    ...
    \n•  **Example :** `.كول + الجمله المراد اظهارها [المطـور]<buttonurl:https://t.me/MFMVIP> [طوكيو]<buttonurl:https://t.me/TOKYO_TEAM> [𝙎𝙤𝙪𝙧𝙘𝙚 𝙏𝙤𝙠𝙔𝙤]<buttonurl:https://t.me/TOKYO_TEAM>`\
    \n\n•  **Syntax : **`.كوول`\
    \n•  **Function :** __Buttons must be in the format as [Name on button]<buttonurl:link you want to open>__\
    \n•  **Example :** `.كوول + الجمله المراد اظهارها [المطـور]<buttonurl:https://t.me/MFMVIP> [طوكيو]<buttonurl:https://t.me/TOKYO_TEAM> [𝙎𝙤𝙪𝙧𝙘𝙚 𝙏𝙤𝙠𝙔𝙤]<buttonurl:https://t.me/TOKYO_TEAM>`\
    "
    }
)
