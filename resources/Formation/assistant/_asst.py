...
# for alive
Def = str(ALIVE_NAME) if ALIVE_NAME else "TOKYO - User"
...
asst_c += "[Assistant By ](https://t.me/MFMVIP)"
...
# Set TOKYO-Bot in @botfather
SetMsg = [
    "✘ ∫  يتم تنصيب بوتك في @botfather",
    "✘ ∫  يتم اكمال تنصيب بوتك في @BotFather",
    "✘ ∫  تم تنصيب بوتك"
]
SetDec = "- 𝙈𝙐𝙎𝙏𝘼𝙁𝘼 𝘼𝙎𝙎𝙄𝙎𝙏𝘼𝙉𝙏 𝘽𝙊𝙏 🔱\n- 𝙏𝙤𝙠𝙔𝙤 𝘽𝙊𝙏 𝙁𝙊𝙍 ~ {}\n- 𝙎𝙊𝙐𝙍𝘾𝙀 𝘿𝙀𝙑 ~ @MFMVIP 𖤨"
SetAbt = "- 𝙎𝙤𝙪𝙧𝙘𝙚 𝙏𝙤𝙠𝙔𝙤 🔱\n- 𝙏𝙤𝙠𝙔𝙤 𝘽𝙊𝙏 𝙁𝙊𝙍 ~ {}"

# This is For TOKYO - Userbot only!!
