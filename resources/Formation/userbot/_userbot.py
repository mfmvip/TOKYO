...
ICS_ID = ["911945965", "911945965"]

# for print :
usr = "MFM USERBOT -{}".format(Tlk)
adn = "MFM ADMIN TOOLS -{}".format(Tlk)
ani = "MFM ANIMATIONS -{}".format(Tlk)
tsh = "MFM TOSHA -{}".format(Tlk)
ast = "MFM ASSISTANT -{}".format(Tlk)
pmt = "MFM ASSISTANT PM -{}".format(Tlk)
